...
- [x] Same unmodified pilot on an Apple M5 Max, release MLX f32 `english`, one model load, 300 rows, 0 failures: AG News 0.960 (p50 8.2 ms, p95 9.7 ms), DAIR Emotion 0.440 (p50 7.4 ms, p95 7.9 ms), Banking77 0.700 (p50 697.6 ms, p95 7.10 s, slowest row 10.8 s). Brier / ECE: AG News 0.098 / 0.137, DAIR Emotion 0.975 / 0.424, Banking77 0.495 / 0.223. True-label probability 0 on none of the 300 rows
